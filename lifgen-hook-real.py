...
NUM_WORDS, NUM_TOKENS, BEAM_WIDTH, ALPHA_MODE,
     ...
     MODEL_NAME = "meta-llama/Llama-2-7b-chat-hf" #"mistralai/Mistral-7B-Instruct-v0.1" #"mistralai/Mistral-7B-Instruct-v0.1" 
...
trust_remote_code=True, token=hf_token)
     ...
     EngineID = f"meta-llama/Llama-2-7b-chat-hf ({DEVICE.upper()})"  # Updated EngineID "#f"DeepSeek R1 1.5B Qwen-Distil Greedy ({DEVICE.upper()})"  # Updated EngineID
